...
namespace DMSApi.Models.IRepository
{
    public interface IRequisitionRepository
    {
        ...
        bool cancelRequisitionWithReason(long requisition_master_id, long userid, string reason_for_cancel_hold);
        bool holdRequisitionWithReason(long requisition_master_id, long userid, string reason_for_cancel_hold);
    }
}
