...
namespace DMSApi.Models
{
    ...
    public partial class local_purchase_order_details
    {
        public long local_purchase_order_details_id { get; set; }
        public Nullable<long> local_purchase_order_master_id { get; set; }
