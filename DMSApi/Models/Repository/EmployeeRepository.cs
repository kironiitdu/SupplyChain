    ...
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public bool EditEmployee(EmployeeModel employeeModel)
        {
            ...
            { 
                ...
                if (employeeModel.is_user)
                {
                    var existingUser = _entities.users.FirstOrDefault(u => u.emp_id == emp.employee_id);
                    // password already encrypted, no need to hash
                    var hashPassword = (employeeModel.password.Length > 60 && employeeModel.password.Contains("|")) ? employeeModel.password : PasswordHash.HashPassword(employeeModel.password);
                    ...
                    else
                    {
                        ...
                        {
                            existingUser.role_id = employeeModel.role_id;
                            _entities.SaveChanges();
                        }
                        else
                        {
