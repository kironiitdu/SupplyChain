...
namespace DMSApi.Controllers
{
    ...
    public class ReportController : ApiController
    {
        ...
        [HttpGet, ActionName("GetAccountsReport")]
        public HttpResponseMessage GetAccountsReport(string fromDate, string toDate, long partyTypeId,
            long partyId, string receivedInvoiceNo)
        {
            try
            {
                var reports = reportRepository.GetAccountsReport(fromDate, toDate, partyTypeId, partyId, receivedInvoiceNo);
                var formatter = RequestFormat.JsonFormaterString();
                return Request.CreateResponse(HttpStatusCode.OK, reports, formatter);
            }
            catch (Exception ex)
        ...
        public HttpResponseMessage GetSalableAndNonSalableStock()
        {
         ...
         [HttpGet, ActionName("GetAllInvoiceNo")]
        public HttpResponseMessage GetAllInvoiceNo()
        {
            var invoiceNo = reportRepository.GetAllInvoiceNo();
            var formatter = RequestFormat.JsonFormaterString();
            return Request.CreateResponse(HttpStatusCode.OK, invoiceNo, formatter);
        }
         [HttpGet, ActionName("GetAllInvoiceNo")]
         public HttpResponseMessage GetAllInvoiceNo(long partyId)
         {
             var invoiceNo = reportRepository.GetAllInvoiceNo(partyId);
             var formatter = RequestFormat.JsonFormaterString();
             return Request.CreateResponse(HttpStatusCode.OK, invoiceNo, formatter);
         }
