...
namespace DMSApi.Controllers
{
    ...
    public class RequisitionController : ApiController
    {
        ...
        public HttpResponseMessage cancelRequisitionWithReason(long requisition_master_id, long userid, string reason_for_cancel_hold)
        {
            try
            {
                requisitionRepository.cancelRequisitionWithReason(requisition_master_id, userid, reason_for_cancel_hold);
                var formatter = RequestFormat.JsonFormaterString();
                return Request.CreateResponse(HttpStatusCode.OK,
        ...
        //04.07.2017
        [HttpGet, ActionName("holdRequisitionWithReason")]
        public HttpResponseMessage holdRequisitionWithReason(long requisition_master_id, long userid, string reason_for_cancel_hold)
        {
            try
            {
                requisitionRepository.holdRequisitionWithReason(requisition_master_id, userid, reason_for_cancel_hold);
                var formatter = RequestFormat.JsonFormaterString();
                return Request.CreateResponse(HttpStatusCode.OK,
                new Confirmation { output = "success", msg = "Requisition Hold successfully" }, formatter);
