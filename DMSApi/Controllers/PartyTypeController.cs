...
namespace DMSApi.Controllers
{
    ...
    public class PartyTypeController : ApiController
    {
        ...
        [HttpGet, ActionName("GetPartyTypeByAreaId")]
        public HttpResponseMessage GetPartyTypeByAreaId(long areaId)
        {
            var partyType = partyTypeRepository.GetPartyTypeByAreaId(areaId);
            var formatter = RequestFormat.JsonFormaterString();
            return Request.CreateResponse(HttpStatusCode.OK, partyType, formatter);
        }
