...
namespace DMSApi.Controllers
{
    ...
    public class ReceiveSerialNoDetailsController : ApiController
    {
        ...
        public HttpResponseMessage GetProductInformation(long imei_no, int party_id)
        {
            try
            {
        ...
        public HttpResponseMessage GetProductInformationForCentral(long imei_no)
        {
            try
            {
        ...
        public HttpResponseMessage GetProductInformationForDirectTransfer(long imei_no, int from_warehouse_id)
        {
            try
            {
        ...
        public HttpResponseMessage GetProductInfoByImeiFromWarehouse(long imei_no, int from_warehouse_id)
        {
            try
            {
        ...
        public HttpResponseMessage GetProductInformationForScan(long imei_no, int from_warehouse_id)
        {
            try
            {
