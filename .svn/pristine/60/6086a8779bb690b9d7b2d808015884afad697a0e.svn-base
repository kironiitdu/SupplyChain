...
namespace DMSApi.Controllers
{
    ...
    public class PartyController : ApiController
    {
        ...
        [HttpGet, ActionName("GetPartyByPartyTypeIdAndAreaId")]
        public HttpResponseMessage GetPartyByPartyTypeIdAndAreaId(long partyTypeId, long areaId)
        {
            var party = partyRepository.GetPartyByPartyTypeIdAndAreaId(partyTypeId, areaId);
            var formatter = RequestFormat.JsonFormaterString();
            return Request.CreateResponse(HttpStatusCode.OK, party, formatter);
        }
