...
namespace DMSApi.Controllers
{
    ...
    public class ProductController : ApiController
    {
        ...
        [HttpGet, ActionName("GetAllAccessories")]
        public HttpResponseMessage GetAllAccessories()
        {
            var countries = productRepository.GetAllAccessories() ;
            var formatter = RequestFormat.JsonFormaterString();
            return Request.CreateResponse(HttpStatusCode.OK, countries, formatter);
        }
        ...
        [HttpPost, ActionName("GetProductByProductId")]
        public HttpResponseMessage GetProductByProductId(long Product_id)
        {
            var countries = productRepository.GetProductById(Product_id);
            var formatter = RequestFormat.JsonFormaterString();
            return Request.CreateResponse(HttpStatusCode.OK, countries, formatter);
        }
    }
